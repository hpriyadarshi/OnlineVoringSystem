            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "
                  <div class='progress'>
                    <div class='progress-bar progress-bar-success' role='progressbar' aria-valuenow=\"$bjp_value\" aria-valuemin=\"0\" aria-valuemax=\"10000\" style='width: ".$bjp_value."%'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "
                  <div class='progress'>
                    <div class='progress-bar progress-bar-primary' role='progressbar' aria-valuenow=\"$inc_value\" aria-valuemin=\"0\" aria-valuemax=\"10000\" style='width: ".$inc_value."%'>
                      <span class='sr-only'>BJP</span>
                    </div>
                  </div>
                  ";
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "
                  <div class='progress'>
                    <div class='progress-bar progress-bar-info' role='progressbar' aria-valuenow=\"$aap_value\" aria-valuemin=\"0\" aria-valuemax=\"10000\" style='width: ".$aap_value."%'>
                      <span class='sr-only'>BJP</span>
                    </div>
                  </div>
                  ";
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "
                  <div class='progress'>
                    <div class='progress-bar progress-bar-warning' role='progressbar' aria-valuenow=\"$tmc_value\" aria-valuemin=\"0\" aria-valuemax=\"10000\" style='width: ".$tmc_value."%'>
